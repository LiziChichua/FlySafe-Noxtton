...
//        apiManager.fetchSelf(token: "4d3f3196-d3eb-414f-91b6-2fb42d92426c") { Response in
//            if let response = Response{
//                print (response.user)
//            }
//        }
        
//        apiManager.createUser(userEmail: "nicolas1213@gmail.com", userPassword: "123", userData: UserData(nationality: "Georgian", vaccine: "pfizer")) { Response in
//            if let response = Response{
//                print (response)
//            }
//        }
